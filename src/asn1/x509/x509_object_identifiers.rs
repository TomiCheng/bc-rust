...
define_oid!(STATE_OR_PROVINCE_NAME, ATTRIBUTE_TYPE, "8", "state, or province name - StringType(SIZE(1..64))");
...
define_oid!(ORGANIZATIONAL_UNIT_NAME, ATTRIBUTE_TYPE, "11", "organizational unit name - StringType(SIZE(1..64))");
...
define_oid!(GENDER, ID_PDA, "3", "RFC 3039 DateOfBirth - PrintableString (SIZE(1)) -- \"M\", \"F\", \"m\" or \"f\"");
define_oid!(COUNTRY_OF_CITIZENSHIP, ID_PDA, "4", "RFC 3039 CountryOfCitizenship - PrintableString (SIZE (2)) -- ISO 3166");
define_oid!(COUNTRY_OF_RESIDENCE, ID_PDA, "5", "RFC 3039 CountryOfResidence - PrintableString (SIZE (2)) -- ISO 3166");
